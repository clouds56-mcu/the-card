...
| 19 | Hardware | Lanyard / clip hardware | — | distributor | 1 kit | 1.00 | 0.50 | 0.35 |
| 20 | Battery | Li-Po 3.7 V 1000 mAh | 603048 | distributor | 1 | 4.00 | **2.50** | 2.00 |
| 21 | PCB | 4-layer, 0.8 mm | JLCPCB | — | 1 | 5.00 | **1.50** | 0.80 |
...
### Component subtotal (excl. #17 optional motor, #19 hardware, #21 PCB)

| Tier | Subtotal |
|---|---|
| **@1 (prototype)** | ≈ $28.0 |
| **@100 (small batch)** | ≈ **$20.9** |
| **@1k (production)** | ≈ $17.7 |
...
| Item | @1 | @100 | @1k |
|---|---|---|---|
| Components (incl. panel/battery) | 28.0 | 20.9 | 17.7 |
...
| **Per-unit total** | **~$39** | **~$27** | **~$21** |

² A single prototype is usually hand-soldered or run as a 1-off PCBA order (adds ~$15–30 NRE, high when amortized to one board).

> Recommendation: **first run 5–10 prototypes** (PCBA ~$40–50 each), validate, then do a small batch of 100 (~$27/unit).
...
```
@100 unit component breakdown (base $20.9)
...
| NFC → passive NTAG216 sticker | -$0.3 | Loses MCU dynamic rewrite / energy harvesting |
